...
> **최종 수정일:** 2026-04-01
>
> 강전희·엄동란, 혼자 공부하는 R 데이터 분석 (한빛미디어) Ch 8

> **선수 지식**: [프로그래밍언어] R 프로그래밍 (제1-7장). [통계학] 회귀 분석 (제7장).
>
> **학습 목표**:
> 1. 시계열을 추세, 계절, 잔차 성분으로 분해할 수 있다
> 2. 시계열 예측을 위해 ARIMA 모델을 적용할 수 있다
> 3. 적절한 지표를 사용하여 예측 정확도를 평가할 수 있다
