...
> **최종 수정일:** 2026-04-01
>
> 강전희·엄동란, 혼자 공부하는 R 데이터 분석 (한빛미디어) Ch 5

> **선수 지식**: [프로그래밍언어] R 프로그래밍 (제1-4장).
>
> **학습 목표**:
> 1. ggplot2 그래픽 문법을 사용하여 통계 그래프를 생성할 수 있다
> 2. 미학, 스케일, 테마를 커스터마이즈할 수 있다
> 3. 여러 geom으로 계층화된 시각화를 구축할 수 있다
