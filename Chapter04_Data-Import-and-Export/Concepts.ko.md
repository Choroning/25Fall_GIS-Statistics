...
> **최종 수정일:** 2026-04-01
>
> 강전희·엄동란, 혼자 공부하는 R 데이터 분석 (한빛미디어) Ch 4

> **선수 지식**: [프로그래밍언어] R 함수 (제1-3장).
>
> **학습 목표**:
> 1. CSV, Excel 등 다양한 형식의 데이터를 R로 가져올 수 있다
> 2. 가져온 데이터셋을 정제하고 전처리할 수 있다
> 3. 처리된 데이터를 다양한 파일 형식으로 내보낼 수 있다
