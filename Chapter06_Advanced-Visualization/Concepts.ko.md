...
> **최종 수정일:** 2026-04-01
>
> 강전희·엄동란, 혼자 공부하는 R 데이터 분석 (한빛미디어) Ch 6

> **선수 지식**: [프로그래밍언어] R과 ggplot2 기초 (제1-5장).
>
> **학습 목표**:
> 1. plotly와 leaflet으로 대화형 시각화를 생성할 수 있다
> 2. 패싯을 사용하여 다중 패널 그래프를 구성할 수 있다
> 3. 사용자 정의 주석으로 출판 품질의 그래프를 디자인할 수 있다
